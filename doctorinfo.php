<?php include('header.php'); ?>
	...
	<div class="doctors">
		                    ...
		                    <h3 class="text-center" style="background-color:#272327;color: #fff;">Doctors</h3>
                            <div class="col-md-12" style="">
                                  


                                  <div class="col-md-3">
                                      <img src="img/11.jpg" alt="" class="img-responsive" style="width: 220px;height: 220px">
                                  </div> <br>

                                  <div class="col-md-3" > 

                                     
                                     <h3 style="color:#0616BC;">Dr. Priyanshu</h3>
                                 ...
                                 <div class="col-md-3">
                                      <img src="img/12.jpg" alt="" class="img-responsive" style="width: 220px;height: 220px"> <br>
                                  </div>

                                  <div class="col-md-3">
                                       
                                       <h3 style="color:#0616BC;">Dr. SHyam</h3>
                            ...
                            <br><br>
                             ...
                             <div class="col-md-12" style="">
                                  ...
                                  <div class="col-md-3">
                                      <img src="img/13.jpg" alt="" class="img-responsive" style="width: 220px;height: 220px">
                                  </div>

                                  <div class="col-md-3" > 

                                     
                                     <h3 style="color:#0616BC;">Dr. SMRI</h3>
                                 ...
                                 <div class="col-md-3">
                                      <img src="img/14.png" alt="" class="img-responsive" style="width: 220px;height: 220px">
                                  </div>

                                  <div class="col-md-3">
                                       
                                       <h3 style="color:#0616BC;">Dr. Smrithi</h3>
